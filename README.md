...
Dataset (400K Records) ↓ Data Preprocessing & Cleaning ↓ Feature Engineering & EDA ↓ ML Model Training (Classification + Regression) ↓ MLflow Experiment Tracking ↓ Model Evaluation & Selection ↓ Streamlit Web Application ↓ Cloud Deployment
...
Due to GitHub file size limitations, the dataset and trained models are hosted on Google Drive.
